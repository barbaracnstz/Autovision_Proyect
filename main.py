...
autos = [2, 3, 5, 7]  # Clases de vehículos en COCO: [Car, Motorcycle, Bus, Truck]
...
while ret:
    ...
    if cv2.waitKey(1) == 27:  # Si se presiona ESC
        break

# Mostrar el contenido del diccionario resultados
